...
const Factions: React.FC = () => {
  ...
  const [factionText, setFactionText] = React.useState('');

  React.useEffect(() => {
    switch (params.faction) {
      case 'pirates':
        setFactionText(`## Space Pirates (Chaotic Individualistic Faction)
...
Retrofitting Convoy / Mining Ships for Makeshift Rams and Combat Vessels`);
        break;
      case 'zombies':
        setFactionText(`## Space Zombies (Neutral Reserved Faction)
...
Technological Prowess and Hacking`);
        break;
      case 'clowns':
        setFactionText(`## Clowns (Wildcard Neutral Faction)
...
The Jonkler (Balloon Animal Summoner)`);
        break;
      default:
        setFactionText('something brokey lol');
        break;
    }
  });
  return (
